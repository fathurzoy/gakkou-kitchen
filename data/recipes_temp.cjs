...
const recipes = [
  {
    ...
    furigana_name: [
      { text: "鶏肉", reading: "とりにく", meaning: "Daging Ayam" },
      { text: "の", reading: "", meaning: "" },
      { text: "甘辛煮", reading: "あまからに", meaning: "Masakan Manis-Pedas" },
    ],
    isHalal: true,
    category: "indonesia",
    difficulty: "mudah",
    ...
    steps: [
      {
        ...
        furigana_words: [
          { kanji: "鶏肉", reading: "とりにく" },
          { kanji: "玉ねぎ", reading: "たまねぎ" },
          { kanji: "薄切", reading: "うすぎり" },
        ],
      },
      {
        id: 2,
        ...
        furigana_words: [{ kanji: "炒", reading: "いた" }],
      },
      {
        id: 3,
...

  {
    ...
    furigana_name: [
      { text: "卵", reading: "たまご", meaning: "Telur" },
      { text: "チャーハン", reading: "", meaning: "Nasi Goreng" },
    ],
    isHalal: true,
    category: "indonesia",
    difficulty: "mudah",
    ...
    steps: [
      {
        ...
        furigana_words: [{ kanji: "塩", reading: "しお" }],
      },
      {
        id: 2,
        ...
        furigana_words: [{ kanji: "強火", reading: "つよび" }],
      },
      {
        id: 3,
      ...
      },
      {
        ...
        furigana_words: [{ kanji: "味付け", reading: "あじつけ" }],
      },
    ],
    survival_phrases: [
      {
...

  {
    ...
    furigana_name: [
      { text: "テンペの", reading: "", meaning: "Tempe" },
      { text: "唐揚", reading: "からあ", meaning: "Gorengan" },
      { text: "げ風", reading: "ふう", meaning: "Gaya" },
    ],
    isHalal: true,
    category: "indonesia",
    difficulty: "mudah",
    ...
    steps: [
      {
        ...
        furigana_words: [{ kanji: "切", reading: "き" }],
      },
      {
        id: 2,
        ...
        furigana_words: [{ kanji: "漬", reading: "つ" }],
      },
      {
        id: 3,
      ...
      },
      {
        ...
        furigana_words: [{ kanji: "召し上がれ", reading: "めしあがれ" }],
      },
    ],
    survival_phrases: [
      {
...

  {
    ...
    furigana_name: [
      { text: "ジャワ風", reading: "ふう", meaning: "Gaya Jawa" },
      { text: "焼きそば", reading: "やきそば", meaning: "Mie Goreng" },
    ],
    isHalal: true,
    category: "indonesia",
    difficulty: "sedang",
    ...
    steps: [
      {
        ...
        furigana_words: [{ kanji: "細切", reading: "ほそぎ" }],
      },
      {
        id: 2,
      ...
      },
      {
        ...
        furigana_words: [
          { kanji: "強火", reading: "つよび" },
          { kanji: "炒め合わせ", reading: "いためあわせ" },
        ],
      },
      {
        id: 4,
...

  {
    ...
    name_jp_plain: "モヒンガー",
    furigana_name: [
      { text: "モヒンガー", reading: "", meaning: "Mohinga" },
      { text: "（ミャンマー", reading: "", meaning: "(Myanmar" },
      { text: "魚介麺", reading: "ぎょかいめん", meaning: "Mie Seafood)" },
    ...
    steps: [
      {
        ...
        furigana_words: [{ kanji: "煮", reading: "に" }],
      },
      {
        id: 2,
      ...
      },
      {
        ...
        furigana_words: [{ kanji: "器", reading: "うつわ" }],
      },
    ],
    survival_phrases: [
      {
...

  {
    ...
    name_jp_plain: "ダルバート",
    furigana_name: [
      { text: "ダルバート", reading: "", meaning: "Dal Bhat" },
      { text: "（ネパール", reading: "", meaning: "(Nepal" },
      { text: "豆", reading: "まめ", meaning: "Kacang" },
      { text: "カレー）", reading: "", meaning: "Kari)" },
    ],
    isHalal: true,
    category: "nepal",
    difficulty: "sedang",
    ...
    steps: [
      {
        ...
        furigana_words: [{ kanji: "浸", reading: "ひた" }],
      },
      {
        id: 2,
      ...
      },
      {
        ...
        furigana_words: [{ kanji: "盛り付け", reading: "もりつけ" }],
      },
    ],
    survival_phrases: [
      {
...

  {
    ...
    furigana_name: [
      { text: "ほうれん草", reading: "そう", meaning: "Bayam" },
      { text: "の", reading: "", meaning: "" },
      { text: "澄まし汁", reading: "すましじる", meaning: "Sup Bening" },
    ],
    isHalal: true,
    category: "indonesia",
    difficulty: "mudah",
...

  {
    ...
    furigana_name: [
      { text: "ツナマヨ", reading: "", meaning: "Tuna Mayo" },
      { text: "おにぎり", reading: "", meaning: "Nasi Kepal" },
    ],
    isHalal: true,
    category: "jepang",
    difficulty: "mudah",
    ...
    steps: [
      ...
      },
      {
        ...
        furigana_words: [
          { kanji: "三角形", reading: "さんかっけい" },
          { kanji: "握って", reading: "にぎって" },
        ],
      },
    ],
    survival_phrases: [
...

  {
    ...
    name_jp_plain: "フォー",
    furigana_name: [
      { text: "フォー", reading: "", meaning: "Phở" },
      { text: "（ベトナム", reading: "", meaning: "(Vietnam" },
      { text: "牛肉", reading: "ぎゅうにく", meaning: "Daging Sapi" },
      { text: "スープ）", reading: "", meaning: "Sup)" },
    ],
    isHalal: true,
    category: "vietnam",
    difficulty: "sedang",
...

  {
    ...
    furigana_name: [
      { text: "卵", reading: "たまご", meaning: "Telur" },
      { text: "かけ", reading: "", meaning: "siram" },
      { text: "ご飯", reading: "ごはん", meaning: "Nasi" },
    ],
    isHalal: true,
    category: "jepang",
    difficulty: "mudah",
...
const getRecipeBySlug = (slug) => recipes.find((r) => r.slug === slug);

const categories = [
  { id: "semua", label_id: "Semua", label_jp: "すべて", emoji: "🌏" },
  { id: "indonesia", label_id: "Indonesia", label_jp: "インドネシア", emoji: "🇮🇩" },
  { id: "jepang", label_id: "Jepang", label_jp: "日本", emoji: "🇯🇵" },
  { id: "myanmar", label_id: "Myanmar", label_jp: "ミャンマー", emoji: "🇲🇲" },
  { id: "nepal", label_id: "Nepal", label_jp: "ネパール", emoji: "🇳🇵" },
  { id: "vietnam", label_id: "Vietnam", label_jp: "ベトナム", emoji: "🇻🇳" },
];
